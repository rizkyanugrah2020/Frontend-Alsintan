      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td key="urea" :props="props">
            {{ props.row._sum.urea }} Kg
          </q-td>
          <q-td key="npk" :props="props">
            {{ props.row._sum.npk }} Kg
          </q-td>
          <q-td key="npkfk" :props="props">
            {{ props.row._sum.npkfk }} Kg
          </q-td>
        </q-tr>
      </template>
    </q-table>
    ...
    >
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td key="urea" :props="props">
            {{ props.row._sum.totalUrea }} Kg
          </q-td>
          <q-td key="npk" :props="props">
            {{ props.row._sum.totalNpk }} Kg
          </q-td>
          <q-td key="npkfk" :props="props">
            {{ props.row._sum.totalNpkFk }} Kg
          </q-td>
        </q-tr>
      </template>
    </q-table>
...
export default {
  ...
  methods: {
    getData () {
      ...
      this.$axios.get(`alokasi/jatah-kios/${this.$getProfile().nik}`, this.$createToken(params))
