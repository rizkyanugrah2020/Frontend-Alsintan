...
export default defineComponent({
      ...
      listImage: [
        {
          ...
          subTitle: 'Permohonan Peminjaman Baru Yang Sedang Ditinjau Oleh Penyedia Alsintan',
          total: 0
        },
        {
  ...
  methods: {
    ...
    getSummary () {
      this.$axios.get(`alsintan/transaksi/member/summary/${profile.member.id_member}`, this.$createToken())
        .then(res => {
